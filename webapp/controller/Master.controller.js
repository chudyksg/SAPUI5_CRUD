/*global history */
sap.ui.define([
	"com/team/FootballTeam/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/team/FootballTeam/model/formatter",
	"sap/m/MessageBox"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox) {
	"use strict";

	return BaseController.extend("com.team.FootballTeam.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("TeamName", FilterOperator.Contains, sQuery)];
			} else {
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							TeamId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("TeamId"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				TeamId: encodeURIComponent(oItem.getBindingContext().getProperty("TeamId"))
			}, bReplace);
		},
