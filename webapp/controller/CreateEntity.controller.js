sap.ui.define([
	...
	return BaseController.extend("com.team.FootballTeam.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("TeamSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("TeamSet", oData);
