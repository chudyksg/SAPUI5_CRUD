...
sap.ui.define([
	...
	return BaseController.extend("com.team.FootballTeam.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/TeamName"),
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("TeamSet", oParameter);
		...
		_onBindingChange: function () {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.TeamId,
				sObjectName = oObject.TeamName;
