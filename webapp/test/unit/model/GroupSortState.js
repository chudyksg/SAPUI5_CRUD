sap.ui.define([
	"com/team/FootballTeam/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("TeamName").length, 1, "The sorting by TeamName returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by TeamName and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("TeamName");
