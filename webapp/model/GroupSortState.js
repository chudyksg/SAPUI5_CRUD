sap.ui.define([
	...
	return BaseObject.extend("com.team.FootballTeam.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.team.FootballTeam.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "TeamName");
			}
